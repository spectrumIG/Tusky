...
import com.keylesspalace.tusky.util.ProcessExecutionException
import com.keylesspalace.tusky.util.getLogFile
...
class AboutActivity : BottomSheetActivity(), Injectable {
    ...
    private fun sendLogs() {
        val logFileUri = try {
            ...
            if (e is IOException || e is ProcessExecutionException) {
                Toast.makeText(this, "Could not read logs", Toast.LENGTH_SHORT)
                return
            } else {
                throw e
            }
